...
import org.openapitools.model.CustomerFVO;
import org.openapitools.model.CustomerMVO;
...
public interface CustomerApi {
    ...
    default ResponseEntity<Customer> createCustomer(
        @Parameter(name = "CustomerFVO", description = "The Customer to be created", required = true) @Valid @RequestBody CustomerFVO customerFVO,
    ...
    default ResponseEntity<Customer> patchCustomer(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true, in = ParameterIn.PATH) @PathVariable("id") String id,
        @Parameter(name = "CustomerMVO", description = "The Customer to be patched", required = true) @Valid @RequestBody CustomerMVO customerMVO,
        @Parameter(name = "fields", description = "Comma-separated properties to be provided in response", in = ParameterIn.QUERY) @Valid @RequestParam(value = "fields", required = false) String fields
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<Customer> retrieveCustomer(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true, in = ParameterIn.PATH) @PathVariable("id") String id,
        @Parameter(name = "fields", description = "Comma-separated properties to be provided in response", in = ParameterIn.QUERY) @Valid @RequestParam(value = "fields", required = false) String fields
    ) {
        getRequest().ifPresent(request -> {
