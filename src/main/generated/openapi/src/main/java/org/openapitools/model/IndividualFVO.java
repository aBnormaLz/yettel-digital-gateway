...
public class IndividualFVO extends PartyFVO implements PartyOrPartyRoleFVO {
  ...
  @Valid
  private List<@Valid OtherNameIndividual> otherName;

  @Valid
  private List<IndividualIdentificationFVO> individualIdentification;

  @Valid
  private List<@Valid Disability> disability;

  @Valid
  private List<@Valid LanguageAbility> languageAbility;

  @Valid
  private List<@Valid Skill> skill;
  ...
  */
  ...
  public IndividualFVO href(String href) {
    super.href(href);
    return this;
  }
  ...
  public IndividualFVO creditRating(List<PartyCreditProfile> creditRating) {
    super.creditRating(creditRating);
    return this;
  }

  public IndividualFVO addCreditRatingItem(PartyCreditProfile creditRatingItem) {
